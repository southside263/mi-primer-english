...
- **Banking Policies**
    ...
    - Most of these transactions have commissions
        - Greece citizens, after the 2015 crisis, could only withdraw $60 euros a day,
        ...
        - In El Salvador, remittances represent 23% of their gross domestic product (GDP).
            ...
            - Companies like Western Union have high rates,
                - especially for amounts less than $1000 USD.
- **Commissions or charges**
    
    They only enrich banking institutions and
    
    The gap between rich and poor increases
    
    - For small amounts, about ten dollars,
        - Commissions can be up to more than three dollars, or 33%.
    - For a hundred dollars,
        - the rates range from 12% to 15%.
    
- **Schedule**
    
    To send/receive a remittance:
    
    - both the sender and the recipient must go to the nearest branch
        - during working hours, of course
- **Security**
    
    Going to the Western Union offices poses additional risks, 
    
    - people must bring their cash,
        - increasing the chances of being robbed.
    - If centralized servers fail (which happens frequently),
        - access to any client's funds could be denied.
    

### Centralization vs. Decentralization

The centralization of modern economies produces:

- censorship, abuse of power, corruption, inequality of opportunities, inequality of wealth, and unique sources of failure.

Banks operate through centralized servers, 

- have access to all the financial activities of their users.

What do the banks know of their customers?

- how much you get paid,
- what you spend your money on,
- who you send your money to,
- and everything else related to your bank account.

**Features of a centralized system**
1. You have to trust that the centralized organization will keep your data safe.
2. They have complete control of the system and your data.
3. If the main servers are compromised, your data is at risk. 

Central bank digital currencies (CBDC's) are the continuation of the current system but in digital form. That is to say: mutable, objectionable, closed, centralized, exclusive, and vigilant.

**How do we counteract these phenomena, caused by bad government policies?**


- **Features of a decentralized system. ** It is described as a **peer to peer** or P2P system because:
    1.  People do not have to identify themselves to interact and be interconnected with each other through the internet. 
    2. Everyone is responsible for their own device but lends and shares their resources.
    3. If there is an attack on the network, hackers would have to have control of most computers - this is almost impossible.
    4.  In case there was an error on a server, the rest would not be affected.
    5. Achieve a fairer society - take control away from powerful corporations.

### **Conclusion**

Class discussion: Four global phenomena that happen today, thanks to centralization:
...
Let's ask again, will there be a solution?
